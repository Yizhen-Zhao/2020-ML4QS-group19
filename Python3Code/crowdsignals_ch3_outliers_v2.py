...
def main():
    ...
    RESULT_FNAME = sys.argv[2] if len(sys.argv) > 2 else 'chapter3_result_outliers_v2.csv'
    ...
    for col in outlier_columns:
        ...
        try:
            dataset = OutlierDist.simple_distance_based(dataset, [col], 'euclidean', 0.50, 0.99)
        ...
        try:
            dataset = OutlierDist.local_outlier_factor(dataset, [col], 'euclidean', 8)
